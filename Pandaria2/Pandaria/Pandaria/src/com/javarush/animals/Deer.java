...
public class Deer extends Herbivorous{
    ...
    private int needFood = 50;
    private int locationId;
    private int age;

    public Deer(int locationId) {
    ...
    public void eat() {
        ...
        plant.setPlantsVolume(plantVolume - 10.001);
    ...
    public void Reproduction() {
        ...
        for (int i = 0; i < animals.size(); i++) {
            if(animals.get(i) instanceof Deer && animals.get(i) != this){
                animals.add(new Horse(this.locationId));
                break;
            }
        }
    }
