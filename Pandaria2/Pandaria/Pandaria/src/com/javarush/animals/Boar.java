...
public class Boar extends Herbivorous{
    ...
    public void eat() {
        ...
        double needFood = 50 - satiety;
        plant.setPlantsVolume(plantVolume - (10.001 - needFood*0.00001));
    ...
    public void Reproduction() {
        ...
        for (int i = 0; i < animals.size(); i++) {
            if(animals.get(i) instanceof Boar && animals.get(i) != this){
                animals.add(new Boar(this.locationId));
                break;
            }
        }
    }
